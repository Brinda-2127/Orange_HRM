...
class loginpage:
    ...
    alert_errorMsg_xpath = "//p[@class='oxd-text oxd-text--p oxd-alert-content-text']"
    ...
    def invalid_alert(self):
        text = self.driver.find_element(By.XPATH, self.alert_errorMsg_xpath).text
        return text
